...
export default function WordCloudAnalysis({ data }) {
    ...
    const stopWords = new Set([
        "и", "в", "на", "с", "по", "за", "к", "от", "для", "из", "о", "об", "со", "до", "при", "про",
        "что", "как", "это", "не", "но", "а", "да", "нет", "так", "ещё", "уже", "еще", "или", "да",
        "банк", "банка", "банке", "карта", "карты", "карте", "карту", "деньги", "рубль", "рублей",
        "газпром", "газпромбанк", "отзыв", "очень", "более", "самый", "может", "года", "год", "лет",
        "том", "была", "были", "будет", "есть", "нет", "все", "всё", "мне", "меня", "мой", "моя"
    ]);
